...
class MultiWalkerEnv:
    ...
    def reset(self):
        ...
        self._generate_terrain(self.hardcore, self.level)
    ...
    def _generate_terrain(self, hardcore, level):
        if level == 1:                                      # easy
        ...
        for i in range(self.terrain_length):
            ...
            elif level == 3 and state == PIT and oneshot:
            ...
            elif level == 3 and state == PIT and not oneshot:
                y = original_y
                if counter > 1:
                    y -= 4 * TERRAIN_STEP
            ...
            elif level != 1 and state == STAIRS and oneshot:
            ...
            elif level != 1 and state == STAIRS and not oneshot:
